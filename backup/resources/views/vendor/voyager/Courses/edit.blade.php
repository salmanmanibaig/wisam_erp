...
{{--                                    {{dd($course)}}--}}
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group" >
                                            ...
                                            <input type="text" required  class="form-control" value="{{$course->course_name}}" name="course_name" placeholder="Enter Category">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group" >
                                            <label class="font-weight-bold" for="name">Description<span class="color">*</span></label>
                                            <textarea type="text" rows="6" required  class="form-control" name="course_description" placeholder="Enter Category">{{$course->course_description}}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group" >
                                            <label class="font-weight-bold" for="name">Price<span class="color">*</span></label>
                                            <input type="number" required  class="form-control" value="{{$course->course_price}}" name="course_price" placeholder="Enter Category">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group" >
                                            ...
                                            <input type="date" required  class="form-control" value="{{$course->course_start_date}}" name="course_start_date" placeholder="Enter Category">
                                        </div>
                                    </div>
