                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="form-group-attached">
                                                                    <div class="form-group form-group-default required" id="pick_point_div">
                                                                        ...
                                                                        <select class="form-control select2-hidden-accessible" name="pick_point" id="pick_point" tabindex="-1" aria-hidden="true">
                                                                            <option value="2">House#121,Chaklala Base Faisal Town, Lahore, Pakistan (Hammad Ahmed Khan)</option>
                                                                        </select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 597.578px;">
                                                                            <span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="9" aria-labelledby="select2-pick_point-container">
                                                                                    <span class="select2-selection__rendered" id="select2-pick_point-container" title="House#121,Chaklala Base Faisal Town, Lahore, Pakistan (Hammad Ahmed Khan)">House#121,Chaklala Base Faisal Town, Lahore, Pakistan (Hammad Ahmed Khan)</span>
                                                                                    <span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                                                    </div>
                                                                    <div class="form-group form-group-default required" id="return_shipment_div">
                                                                        <label>is this return shipment ?
                                                                        </label>
