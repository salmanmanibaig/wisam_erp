                ...
                <div class="white-box">
                        ...
                        <div class="row mb-40">
                            <div class="col-lg-6">
                                <div class="input-effect">
                                    ...
                                    type="text" name="school_name" autocomplete="off" value="{{isset($editData)? $editData->company_name : old('school_name')}}">
                           ...
                           <div class="col-lg-3">
                                <div class="input-effect">
                                    <select class="niceSelect w-100 bb form-control{{ $errors->has('language_id') ? ' is-invalid' : '' }}" name="language_id" id="language_id">
                                        <option data-display="@lang('lang.language') *" value="">@lang('lang.select') @lang('lang.language') <span>*</span></option>
                                        @if(isset($languages))
                            ...
                            <div class="col-lg-3">
                                <div class="input-effect">
                                    <select class="niceSelect w-100 bb form-control{{ $errors->has('date_format_id') ? ' is-invalid' : '' }}" name="date_format_id" id="date_format_id">
                                        <option data-display="@lang('lang.select_date_format') @lang('lang.date_formate')  *" value="">@lang('lang.select') @lang('lang.date_formate')  <span>*</span></option>
                    ...
                    <div class="row mt-40">
                        <div class="col-lg-12 text-center">
                            ...
                            @if(Illuminate\Support\Facades\Config::get('app.app_sync'))
                            <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Disabled For Demo "> <button class="primary-btn small fix-gr-bg  demo_view" style="pointer-events: none;" type="button" disabled>  @lang('lang.update')</button></span>
                        @else
