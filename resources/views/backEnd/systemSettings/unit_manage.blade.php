...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.unit_manage')</h1>
            <div class="bc-pages">
                <a href="{{url('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('lang.accounts')</a>
                <a href="#">@lang('lang.unit_manage')</a>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="main-title">
                            <h3 class="mb-30">@if(isset($unit_manage))
                                    @lang('lang.edit')
                                @else
                                    @lang('lang.add')
                                @endif
                                @lang('lang.unit_manage')
                            </h3>
                        </div>
                        @if(isset($unit_manage))
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true,  'url' => 'manage-unit-modified', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                        <input type="hidden" name="unit_id" value="{{isset($unit_manage)? $unit_manage->id: ''}}">
                        @else
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'manage-unit-modified', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                        @endif
                        <div class="white-box">
                            <div class="add-visitor">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 mt-40">
                                        <div class="input-effect">
                                            <input class="primary-input form-control{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                                type="text" name="name" autocomplete="off" value="{{isset($unit_manage)? $unit_manage->name:''}}">
                                    ...
                                    <div class="col-lg-12 mt-40">
                                        <div class="input-effect">
                                            <input class="primary-input form-control{{ $errors->has('short_form') ? ' is-invalid' : '' }}"
                                                type="text" name="short_form" autocomplete="off" value="{{isset($unit_manage)? $unit_manage->short_form:''}}"> 
                                            <label>@lang('lang.short_form') <span>*</span></label>
                                            <span class="focus-border"></span>
                                    ...
                                    <div class="col-lg-12 mt-40">
                                        <div class="input-effect">
                                            ...
                                            <input class="primary-input form-control{{ $errors->has('description') ? ' is-invalid' : '' }}"
                                                type="text" name="description" autocomplete="off" value="{{isset($unit_manage)? $unit_manage->description:''}}"> 
            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0">@lang('lang.unit_manage') @lang('lang.list')</h3>
                        </div>
                    </div>
                </div>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right"> 
                                                <a class="dropdown-item" href="{{url('manage-unit-edit', [$row->id])}}">@lang('lang.edit')</a> 
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">@lang('lang.delete') @lang('lang.unit_manage')</h4>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mt-40 d-flex justify-content-between">
                                                    <button type="button" class="primary-btn tr-bg" data-dismiss="modal">@lang('lang.cancel')</button>
                                                     {{ Form::open(['url' => 'manage-unit-delete/'.$row->id, 'method' => 'GET', 'enctype' => 'multipart/form-data']) }}
