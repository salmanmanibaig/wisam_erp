                            ...
                            <table id="table_id" class="display school-table pl-2" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    @foreach($background_settings as $background_setting)
                                     @php
                                    $style="width: 200px; height: 100px;background-color:".@$background_setting->color;
                                @endphp
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <a  class="primary-btn small tr-bg" href="{{url('/background_setting-status')}}/{{@$background_setting->id}}"> @lang('lang.Make_Default')</a> 
