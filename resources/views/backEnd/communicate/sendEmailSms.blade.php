                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-12 d-flex mb-20">
                                            <div class="row">
                                                <p class="text-uppercase fw-500 mb-10">@lang('lang.send') @lang('lang.Through')</p>
                            ...
                            <div class="col-lg-12">
                                ...
                                <strong>{{ $errors->first('leave_type') }}</strong>
                                                ...
                                                <div class="col-lg-12 mt-30" id="selectStaffsDiv">
                                                    ...
                                                    <select multiple id="selectStaffss" name="message_to_individual[]" class="communicate_select_staff_style">
                                                    </select>
