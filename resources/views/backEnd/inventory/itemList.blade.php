...
<section class="admin-visitor-area">
    <div class="container-fluid p-0">
        @if(in_array(154, @$module_links) ||  Auth::user()->role_id == 1)
        @if(isset($editData))
        <div class="row">
                                    ...
                                    <div class="col-lg-12 mb-20">
                                        <div class="input-effect">
                                            ...
                                            <div class="input-effect" id="sectionSubcategoryDiv">
                                                <select class="niceSelect w-100 bb form-control{{ $errors->has('section_sub_category') ? ' is-invalid' : '' }}" name="section_sub_category" id="sectionSelectSubcategory">
                                                   <option data-display="@lang('lang.section_sub_category') *" value="">@lang('lang.section_sub_category') *</option>


                                                    @if(isset($editData))

                                                    <option value="{{@$editData->subcategory_name}}" selected="">{{App\SmItem::getSubcategoryName(@$editData->subcategory_name)}}</option>
