      ...
      <div class="col-lg-3">
        <div class="row">
          <div class="col-lg-12">
            ...
            @else
            @if(in_array(174, @$module_links) ||  Auth::user()->role_id == 1)
            ...
            <div class="col-lg-12 mb-30">
                    <select class="niceSelect w-100 bb form-control{{ $errors->has('user_type') ? ' is-invalid' : '' }}" name="role_id" id="item_category_id_dev">
                  ...
                  <div class="col-lg-12 mb-30" id="selectStaffsDiv" style="display:block">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td> @if(!empty(@$getMemberDetail))
                  ...
                  <td>{{date('jS M, Y', strtotime(@$value->issue_date))}}</td>
                   ...
                   @if(@$value->issue_status == 'I')
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-right">
                       @if(in_array(175, @$module_links) ||  Auth::user()->role_id == 1)
