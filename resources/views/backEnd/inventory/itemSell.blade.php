...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.Item') @lang('lang.Sell')</h1>
            <div class="bc-pages">
                <a href="{{url('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="{{url('item-sell')}}">@lang('lang.Item') @lang('lang.Sell')</a>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-lg-12">
                    <div class="main-title">
                        <h3 class="mb-30">@if(isset($editData))
                            @lang('lang.edit') @lang('lang.Sell')
                            @else

                            @endif
                            @lang('lang.Sell') @lang('lang.details')
                        </h3>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 mb-30">
                                    <div class="input-effect">
                                        ...
                                        <label>@lang('lang.reference') @lang('lang.no_') </label>
        ...
        <div class="col-lg-9">
          ...
          <div class="row">
            <div class="col-lg-4 no-gutters">
                <div class="main-title">
                    <h3 class="mb-30">@lang('lang.Item') @lang('lang.Sell')</h3>
                </div>
            </div>
                 ...
                 <table class="table" id="productTable">
                    <thead>
                      <tr>
                          ...
                          <th>@lang('lang.sell') @lang('lang.price')</th>
