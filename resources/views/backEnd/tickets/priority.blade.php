...
<section class="admin-visitor-area">
    <div class="container-fluid p-0">
       @if(isset($editData))
       @if(in_array(282, @$modules) || Auth::user()->role_id != 7)
        <div class="row">
            <div class="offset-lg-10 col-lg-2 text-right col-md-12 mb-20">
                <a href="{{route('ticket.priority')}}" class="primary-btn small fix-gr-bg">
            ...
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @if(isset($editData))
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => ['ticket.priority_update',@$editData->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                        @else
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => ['ticket.priority_store'],
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="dropdown">
                                    ...
                                    @if(in_array(283, @$modules) || Auth::user()->role_id != 7)
                                        <a class="dropdown-item" href="{{ route('ticket.priority_edit',@$value->id)}}"> @lang('lang.edit')</a>
                                    @endif
                                    @if(in_array(284, @$modules) || Auth::user()->role_id != 7)

                                        <a class="deleteUrl dropdown-item" data-modal-size="modal-md" title="Delete Ticket Priority" href="{{url('ticket-priority-delete-view/'.@$value->id)}}"> @lang('lang.delete')</a>
