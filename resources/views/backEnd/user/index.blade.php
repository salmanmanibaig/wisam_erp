        ...
        @if(in_array(224, @$module_links) ||  Auth::user()->role_id == 1)
            <div class="col-lg-12 mt-40 ">
                <div class="white-box">
                    <div class="main-title">
                        <h3 class="mb-10">
                            @lang('lang.pending') @lang('lang.leave') @lang('lang.application') @if($apply_leaves != null) ({{count(@$apply_leaves)}}) @endif
                        </h3>
                    </div>
                    <table id="dashboard_table_id" class="p-0 school-table-style w-100 without-box-shadow">
                        <thead>
                                            ...
                                            <div class="row mt-30">
                                                <div class="col-lg-12" id="">
                                                    <div class="no-gutters input-right-icon">
                                                        <div class="col">
                                                            <div class="input-effect">
                                                                <input autocomplete="off" class="read-only-input primary-input date 
                                                                form-control{{ $errors->has('date') ? ' is-invalid' : '' }}" id="startDate" name="date"
                                                                 readonly="true" type="text" value="{{date('m/d/Y')}}">
                                                                    <label>
                                                                        @lang('lang.date')
                                                                        <span>
                                                                        </span>
