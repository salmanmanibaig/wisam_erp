                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="panel panel-bordered">
                            <!-- form start -->
                            <form action="{{url('admin/requirments/'.$requirment->id)}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="panel-body">
                                            ...
                                            <div class="form-group" >
                                                ...
                                                <select class="form-control select2" name="hospital_id">
                                                    ...
                                                    @foreach($hospitals as $hospital)
                                                        <option @if($requirment->hospital_id == $hospital->id) selected @endif value="{{$hospital->id}}">{{$hospital->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    @endif
                                                                        <div class="col-md-6">
                                                                            <div class="form-group" >
                                                                                <label class="font-weight-bold" for="name">Change Status<span class="color">*</span></label>

                                                                                    <select required class="form-control select2" name="status">
                                                                                        <option value="">Select One</option>
                                                                                        <option @if($requirment->status == '0') selected @endif value="0">New Requirment</option>
                                                                                        <option  @if($requirment->status == '2') selected @endif value="2">Complete</option>
                                                                                             </select>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group" >
                                            ...
                                            <input type="text" required  class="form-control" name="department" value="{{ $requirment->department }}" placeholder="Department">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group" >
                                            ...
                                            <textarea type="text" rows="6"  required  class="form-control" name="requirment_text" > {{$requirment->requirment_text}} </textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group" >
                                            <label class="font-weight-bold" for="name">Number of meals<span class="color">*</span></label>
                                            <input type="number" rows="6" required  class="form-control" value="{{ $requirment->number_of_meals }}"  name="number_of_meals" placeholder="ie.150"></input>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group" >
                                            ...
                                            <input type="date" required  class="form-control" value="{{ $requirment->req_on_date }}"name="req_on_date" placeholder="Enter Category">
                                        </div>
                                    </div>
                                    ...
                                    <div class="panel-footer">
                                        <button id="submit" type="submit" style="margin-left: 44%;" class="btn btn-primary save">{{ ('Update') }}</button>
                                    </div>
