...
@php  $product=App\User::first(); @endphp
@can('edit',$product)
@section('css')
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-3">
                                <div class="form-group" >
                                    ...
                                    <input type="number" required class="form-control" name="doz_cart" placeholder="eg.100">
                                </div>
                            </div>
                            ...
                            <table class="table table-hover" id="myTable">
                                ...
                                <tr>
                                    ...
                                    <td><input type="number" name="in_qty[]" placeholder="" required class="form-control"></td>
        ...
        $(document).ready(function(){
            ...
            $("#btn2").click(function(){
                ...
                $("#acc_table").append("<tr>\n" +
                    ...
                    // "                            <td><input type=\"text\" name=\"board_type[]\"  required class=\"form-control\"></td>\n" +
                    // "                            <td><input type=\"text\" name=\"board_type[]\"  required class=\"form-control\"></td>\n" +
                    "                            <td><input type=\"number\" name=\"in_qty[]\"  required class=\"form-control\"></td>\n" +
                    "\n" +
