...
@php  $SupplyRequisition=App\Customer::first(); @endphp
...
@section('css')
    ...
    <style>
        ...
        @media print
        {
            .view_invoice,.selection, .no-print *
            {
        ...
        <div class="row selection">
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    <!-- form start -->
                    <form   id="reports" action="{{url('admin/customer-delivery-report/')}}" method="post"   enctype="multipart/form-data">
                        <!-- PUT Method if we are editing -->
                        <!-- CSRF TOKEN -->
                        {{ csrf_field() }}
                        <div class="panel-body">

                            <legend class="" style="">Generate Customer Payment Report</legend>
                            <div class="col-md-12">
                                <div class="col-md-3">
                                    <div class="form-group" >
                                        <label class="font-weight-bold" for="name">Select Customer<span class="color">*</span></label>
...
{{--                                            {{dd()}}--}}
                                            @foreach($customers as $cust)
                                                <option class="name_value" @if(@$vendor_name_id==$cust->id || @$customer->id==$cust->id ) selected @endif   value="{{$cust->id}}">
...
{{--{{dd($start_date)}}--}}
        ...
        <div class="table-responsive">
            <div class="col-md-4">
                <h3><i class="glyphicon glyphicon-list-alt" style="color: green;margin-right: 10px;"></i>Customer Name: {{ucfirst(@$customer->name)}}</h3>
            </div>
            <div class="col-md-4">
                        ...
                        <tr id="myTable">
                            ...
                            <td>
                                @if(@$amount['inv_amount'] )
                                    ...
                                    <a id="view_invoice" class="view_invoice" href="{{url('admin/customer-invoice/show/'.$amount['id'])}}"><span id="view" class=" view glyphicon glyphicon-search" style="color: blue;size: 20px;margin-left: 8px;"></span></a>
                                @else
