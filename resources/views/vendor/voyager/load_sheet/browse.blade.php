                        ...
                        <div class="table-responsive">
                            <table id="example" class="table table-hover"  >
                                ...
                                <li class="m-t-5 open active">
                                    <a href="javascript:;">
                                        <span class="title">Load-Sheet</span>
                                ...
                                @if(count($load_sheet)>0)
                                    @foreach($load_sheet as $key => $book)
                                    ...
                                    {{dd($book)}}
                                        ...
                                        <tr id="myTable">
                                            ...
                                            <td>
                                                <span class="font-weight-bold">{{$book->sr}}</span>
                                            </td>

                                            <td>
                                                <span class="font-weight-bold">{{$book->load_sheet}}</span>
                                            </td>

                                            <td>
                                                <span class="font-weight-bold">{{$book->consignments}}</span>
                                            </td>

                                            <td>
                                                <span class="font-weight-bold">{{$book->date}}</span>
                                            </td>


                                            <td>
                                                <span class="font-weight-bold">{{$book->loadsheet_label}}</span>
                                            </td>

                                            <td>
                                                <span class="font-weight-bold">{{$book->address_label}}</span>
                                            </td>

                                            <td>
                                                <span class="font-weight-bold">{{$book->barcode_label}}</span>
                                            </td>
