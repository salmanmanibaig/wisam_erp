    ...
    <div class="container-fluid">
        <div class="row" style="padding-bottom: 0px">
            <div class="col-md-6" style="margin-bottom: 0px">
                ...
                <a href="{{url('admin/employee-salaries/create')}}" class="btn btn-success btn-add-new">
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table table-hover"  >
                                ...
                                @if(count($emp_salary_data)>0)
                                    @foreach($emp_salary_data as$key=> $emp_salary)
{{--                                        @foreach($emp_salary->salary_details as $key2=>$salary_detail)--}}
                                        <tr id="myTable">
                                            ...
                                            <td>{{$emp_salary->created_at->format('Y-m')}}</td>
                                            <td>
                                                <span class="font-weight-bold">{{@$emp_salary->emp_category->name}}</span>
                                            </td>

                                            <td class="no-sort no-click" id="bread-actions">
                                                <div class="btn-toolbar">

                                                    <button dataid="{{$emp_salary->id}}" class="btn btn-danger  customBtn deleteCustom" style="text-decoration: none; font-size: 12px;padding: 5px 7px">
                                                        ...
                                                        <div class="modal-dialog">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form action="{{url('admin/employee-salaries/destroy')}}" method="post">
                                                                        {{csrf_field()}}
                                                                        {{method_field('DELETE')}}
                                                    ...
                                                    <a href='{{url("admin/employee-salaries/{$emp_salary->id}")}}' class="btn btn-warning  des" style="text-decoration: none; font-size: 12px;padding: 5px 7px">
                                                        <i class="voyager-eye"></i> <span>View</span>
                                                    </a>
                                                    <a href='{{url("admin/employee-salaries/{$emp_salary->id}/edit")}}' class="btn btn-info  des" style="text-decoration: none; font-size: 12px;padding: 5px 7px">
