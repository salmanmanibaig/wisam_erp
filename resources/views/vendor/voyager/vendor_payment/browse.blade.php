...
{{--                        <a id="first_widgets" href="{{url('admin/customer_total_check')}}" class="list-group-item visitor">--}}
...
{{--                        <a id="second_widgets" href="{{url('admin/customer_expire_check')}}"  class="list-group-item visitor">--}}


{{--                            <p class="list-group-item-text">--}}
{{--                               Third Party Checks which Expired <span><h3 >--}}
{{--                                {{$third_party_expire_check1}}--}}
{{--                                </h3></span></p>--}}
{{--                        </a>--}}
{{--                    </div>--}}
{{--                    <div class="col-md-3" style="margin-top: 15px;">--}}
{{--                        <a id="third_widgets" href="{{url('admin/customer_today_check')}}"  class="list-group-item visitor">--}}
...
{{--                    </div>--}}
{{--                    <div class="col-md-3" style="margin-top: 15px;">--}}
{{--                        <a id="fourth_widgets" href="{{url('admin/customer_after_today_check')}}"  class="list-group-item visitor">--}}


{{--                            <p class="list-group-item-text">--}}
{{--                               Checks Which Have to Cash After Today  <span><h3 >--}}
...
{{--                                                <option @if($invoice->product_id==$product->id) selected @endif value="{{$product->id}}" class="select_product">{{$product->name}}</option>--}}
                                                <span class="font-weight-bold"> {{@$payments->vendor->f_name}}</span>
                                            </td>
{{--                                            @endif--}}
                                            <td>
