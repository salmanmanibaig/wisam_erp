        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    <!-- form start -->
                    <form   id="reports" action="{{url('admin/customer_reports_post/')}}" method="post"   enctype="multipart/form-data">
...
{{--                                            {{dd()}}--}}
                                            @foreach($customers as $customer)
                                                <option class="name_value" @if($vendor_name_id==$customer->id) selected @endif   value="{{$customer->id}}">
