    ...
    <div class="container-fluid">
        <div class="row" style="padding-bottom: 0px">
            <div class="col-md-6" style="margin-bottom: 0px">
                ...
                <a href="{{url('admin/petty-cash-payments/create')}}" class="btn btn-success btn-add-new">
                                        ...
                                        <tr id="myTable">
                                            ...
                                            <td class="no-sort no-click text-right" id="bread-actions">
                                                <div class="btn-toolbar">
                                                        ...
                                                        <div class="modal-dialog">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form action="{{url('admin/petty-cash-payments/destroy')}}" method="post">
                                                                        {{csrf_field()}}
                                                                        {{method_field('DELETE')}}
                                                    ...
                                                    <a href='{{url("admin/petty-cash-payments/{$petycash->id}")}}' class="btn btn-warning pull-right des" style="text-decoration: none; font-size: 12px;padding: 5px 7px">
                                                        <i class="voyager-eye"></i> <span>View</span>
                                                    </a>
                                                    <a href='{{url("admin/petty-cash-payments/{$petycash->id}/edit")}}' class="btn btn-info pull-right des" style="text-decoration: none; font-size: 12px;padding: 5px 7px">
