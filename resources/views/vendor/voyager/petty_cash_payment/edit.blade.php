    ...
    <div class="page-content edit-add container-fluid">
        <div class="row">
            ...
            <div class="panel panel-bordered">
                <!-- form start -->
                <form action="{{url('admin/petty-cash-payments/'.$pettycash_data->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-2">
                            <div class="form-group" >
                                ...
                                <input type="text" required class="form-control" name="amount" value="{{$pettycash_data->amount}}">
                            </div>
                        </div>
