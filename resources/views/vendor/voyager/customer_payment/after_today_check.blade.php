                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table table-hover">
                                ...
                                <tbody>
{{--                                                                {{dd($third_party_before_current_date_check)}}--}}
                                @if(count((array)$third_party_before_current_date_check)>0)
                                    @foreach(@$third_party_before_current_date_check as $payments)
                                        {{--                                                                                {{dd($product)}}--}}
                                        <tr id="myTable">
