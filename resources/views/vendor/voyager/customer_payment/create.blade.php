            ...
            <div class="col-md-8">
                ...
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        ...
                        <form action="{{url('admin/customer_payment_data_enter')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label class="font-weight-bold" for="name">Select Customer<span
                                ...
                                <div id="accountonlineDiv" style="display: none">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="font-weight-bold" for="name">Customer Account Number<span
                                                    class="color">*</span></label>
                        ...
                        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="{{url('admin/customer_thirdpartycheck')}}" method="post"
                                    ...
                                    <form action="{{url('admin/customer_thirdpartycheck')}}" method="post"
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="font-weight-bold"> Customer Account No.<span
                                                                class="color">*</span></label>
    ...
    <script>
        ...
        $('#account').on("change ", function () {
            ...
            $.ajax({
                ...
                url: public_var+'/admin/vendor-payments/checks/' + account_id,
                type: "GET",
                dataType: "json",
                success: function (data) {
        ...
        $('#checks').on("change ", function () {
            ...
            $.ajax({
                ...
                url:    public_var+'/admin/vendor-payments/check_details/' + checkbook_id,
                type: "GET",
                dataType: "json",
                success: function (data) {
