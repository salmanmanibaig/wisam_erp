...
@section('page_header')
    <div class="container-fluid">
        <div class="row" style="padding-bottom: 0px">
            ...
            <a href="{{url('admin/customer_payment_create')}}" class="btn btn-success">
...
{{--                                                <option @if($invoice->product_id==$product->id) selected @endif value="{{$product->id}}" class="select_product">{{$product->name}}</option>--}}
                                                <span class="font-weight-bold"> {{$payments->customer->name}}</span>
                                            </td>
{{--                                            @endif--}}
                                            <td>
                                                        ...
                                                        <div class="modal-dialog">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form action="{{url('admin/customer_payments/destroy')}}" method="post">
                                                                        {{csrf_field()}}
                                                                        {{method_field('DELETE')}}
...
{{--                                                    href='{{url("admin/payments_show/{$payments->id}")}}'--}}
                                                    <a href="{{url("admin/customer_payments_show/{$payments->id}")}}"  class="btn btn-warning pull-right des" style="text-decoration: none; font-size: 12px;padding: 5px 7px">
