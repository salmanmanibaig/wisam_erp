                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-bordered">
                            <!-- form start -->
                            <form action="{{url('admin/vendor-purchase-orders')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="panel-body">
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <select class="form-control select2" required name="vendor_id" >
                                                @foreach($vendor as $vendors)
                                                    ...
                                                    <option value="{{$vendors->id}}">{{$vendors->vendor_company}}</option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group" >
                                            ...
                                            <select class="form-control select2" required name="po_type" >
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group" >
                                            <label class="font-weight-bold" for="name"> Invoice Number</label>
                                            <input type="text"  class="form-control"  name="p_inv_number" placeholder="Enter Inv Number">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group" >
                                            <label class="font-weight-bold" for="name">Attach  Invoice</label>
                                            <input type="file"  class="form-control"  name="p_attachment" placeholder="Enter Item Name">
                                        </div>
                                    </div>
                                    ...
                                    <table class="table table-hover" id="myTable">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" step="0.01" name="inv_amount"  placeholder="" required class="total form-control"></td>
