                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-bordered">
                            <!-- form start -->
                            <form action="{{url('admin/vendor-purchase-orders/'.$po->id)}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group" >
                                            ...
                                            <select class="form-control select2" required name="vendor_id" >
                                                @foreach($vendor as $vendors)
                                                    ...
                                                    <option  @if($po->vendor_id == $vendors->id) selected @endif value="{{$vendors->id}}">{{$vendors->vendor_company}}</option>
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <select disabled class="form-control   select2" required name="po_type" >
                                                ...
                                                <option @if($po->po_type == 'loan') selected @endif  value="international">Loan</option>
                                    ...
                                    <a href='{{url("admin/vendor-letter-credits/create/".$po->id)}}' class="btn btn-warning  des" style="text-decoration: none; font-size: 12px;padding: 5px 7px">
...
{{--                                                {{dd($po->stock->warehouse_id)}}--}}
                                                <select class="form-control select2" @if($po->stock_status == 1) disabled @endif  name="warehouse_id" >
                                                    <option   value="">Select one</option>
                                                    @foreach($warehouse as $house)


                                                        <option @if($house->id == @$po->stock->warehouse_id)  selected  @endif   value="{{$house->id}}">{{$house->name}}</option>
                                    ...
                                    <table class="table table-hover" id="myTable">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="number" step="0.01" name="inv_amount"  placeholder="" required value="{{$total}}" class="total form-control"></td>
