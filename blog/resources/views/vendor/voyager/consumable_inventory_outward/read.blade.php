...
@php  $prod=App\ConsumeInventoryTransactionOpe::first(); @endphp
@can('read',$prod)
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row " style="text-align: center">
                                <div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 0px">
                                    <p style="font-size: 25px;font-weight: bolder;margin-bottom: 10px;">Outward No #

                                        {{sprintf('%04d',$consumable_inv_transaction->out_ref_no)}}{{'-'}}{{date('Y-m', strtotime($consumable_inv_transaction->transaction_date))}}
                                    </p>
                                </div>
                            ...
                            <div class="row" style="text-align: center">
                                <div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px">
                                    @php
                                        ...
                                        echo '<img src="data:image/png;base64,' . DNS1D::getBarcodePNG(sprintf("%04d",$consumable_inv_transaction->out_ref_no)."-".date('Y-m', strtotime($consumable_inv_transaction->transaction_date))  , "C128",2,50) . '" alt="barcode"   />';
                                    @endphp
                                </div>
                            </div>

                            {{--                            <div class="row">--}}
                            <div style="padding: 0px ;margin-bottom: 0px;" class="col-md-3 col-sm-3 col-xs-3"><div style="margin: 0px;background-color:  rgb(240, 240, 240)!important;-webkit-print-color-adjust: exact;" class="form-control1"><p class="simplefont">OUTWARD NUMBER</p></div></div>
                            <div style="padding: 0px ;margin-bottom: 0px;" class="col-md-3 col-sm-3 col-xs-3"><div style="margin: 0px;" class="form-control1">


                                    <p style="font-weight: bold">{{sprintf('%04d',$consumable_inv_transaction->out_ref_no)}}{{'-'}}{{date('Y-m', strtotime($consumable_inv_transaction->transaction_date))}}</p>
                            ...
                            {{--                            <div class="row">--}}
                            <div style="padding: 0px ;margin-bottom: 0px;" class="col-md-6 col-sm-6 col-xs-6"><div style="margin: 0px;background-color:  rgb(240, 240, 240)!important;-webkit-print-color-adjust: exact;" class="form-control1a"><p class="simplefont">Factory</p></div></div>
                            <div style="padding: 0px ;margin-bottom: 0px;" class="col-md-6 col-sm-6 col-xs-6"><div style="margin: 0px;" class="form-control-bottom"><p class="textfontchk1">{{@$consumable_inv_transaction->factory->name}}</p></div></div>
                            ...
                            @foreach($consumable_inv_transaction->invent_transaction_ope  as $key => $transaction)
                                ...
                                @if($key==0)
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-3 bt0" style="border-right: 0px">
                                        ...
                                        <p style="text-align: center;font-size:16px;font-weight: bold;">{{ (number_format($transaction->quantity,2)) }} </p>
