        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <div class="panel panel-bordered">
                    <!-- form start -->
                    <form action="{{url('admin/approve-localPurchaseOrder/')}}/{{$quotation->id}}" method="POST" enctype="multipart/form-data">
...
{{--                        {{method_field('PUT')}}--}}
                        ...
                        <!-- Adding / Editing -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="font-weight-bold" for="description">Order Description<span class="color">*</span></label>
                                        <input type="text" required class="form-control" name="description"  id="description" placeholder="Enter Order Description">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
...
{{--                                            <input name="uom[]" value="{{$detail->uom}}"  id="" class="form-control uom" readonly>--}}
                        ...
                        <div class="panel-footer">
                            <button type="button" class="btn btn-success" id="btnApprove"  data-toggle="modal" data-target="#exampleModal">APPROVE</button>
                        </div>
{{--                        {{dd($sumPrice)}}--}}
                ...
                $('.price').each(function (){
                    ...
                    if($(this).val()<1)
                    {
                        ...
                        return false;
                            ...
                            $('#modal-header').append('<div id="withPriceModal" style="color: green;" >\n' +
                                '                                                <h2 class="modal-title" id="exampleModalLabel">Are you sure you want to approve this?</h2>\n' +
                                '                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">\n' +
                                '                                                    <span aria-hidden="true">&times;</span>\n' +
                                '                                                </button>\n' +
                                '                                            </div>')
