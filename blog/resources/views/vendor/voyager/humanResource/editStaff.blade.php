...
<section class="admin-visitor-area staff">
                    ...
                    <div class="row mb-30 mt-20">
                        <div class="col-lg-3">
                            <div class="input-effect">
                                <input class="primary-input " type="hidden"  name="staff_no" value="{{@$editData->staff_no}}" readonly>

                                <input class="primary-input form-control{{ $errors->has('staff_no') ? ' is-invalid' : '' }}" type="text" value="infix{{sprintf("%03d", @$editData->staff_no)}}" readonly>


                                <input class="primary-input form-control{{ $errors->has('staff_no') ? ' is-invalid' : '' }}" type="hidden" readonly value="@if(isset($editData)){{@$editData->staff_no}} @endif">
                        ...
                        <div class="col-lg-3">
                            <div class="input-effect">
                                <select class="niceSelect w-100 bb form-control{{ $errors->has('role_id') ? ' is-invalid' : '' }}" {{$role_change}} name="role_id" id="role_id">
...
<div class="col-lg-4">
    <div class="row no-gutters input-right-icon mb-20">
            <div class="col">
                <div class="input-effect">
                    <input class="primary-input form-control {{ $errors->has('other_document') ? ' is-invalid' : '' }}" type="text" placeholder="{{isset($editData->other_document) && @$editData->other_document != ""? showPicName(@$editData->other_document):'Others Documents'}}"
...
<div class="row mt-40">
    <div class="col-lg-12 text-center">
        ...
        @if(Illuminate\Support\Facades\Config::get('app.app_sync'))
        <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Disabled For Demo "> <button class="primary-btn small fix-gr-bg  demo_view" style="pointer-events: none;" type="button" disabled>  @lang('lang.update_staff')</button></span>
    @else
