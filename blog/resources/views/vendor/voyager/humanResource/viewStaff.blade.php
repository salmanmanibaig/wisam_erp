    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="{{route('staff_directory')}}">@lang('lang.staff') @lang('lang.list')</a>
            </div>
        </div>
    </div>
</section>
<section class="mb-40 student-details">
    ...
    <div class="container-fluid p-0">
        <div class="row">
         <div class="col-lg-3">
            ...
            <div class="student-meta-box">
                ...
                <img class="student-meta-img img-100" src="{{ file_exists(@$staffDetails->staff_photo) ? asset($staffDetails->staff_photo) : asset('public/uploads/staff/demo/staff.png') }}" alt="">
                {{-- @if(!empty($staffDetails->staff_photo))

                <img class="student-meta-img img-100" src="{{asset($staffDetails->staff_photo)}}"  alt="">
                @else
                <img class="student-meta-img img-100" src="{{asset('public/uploads/staff/demo/staff.png')}}"  alt="">
                @endif --}}
                <div class="white-box">
           ...
           <div class="single-meta mt-10">
                <div class="d-flex justify-content-between">
                    <div class="name">
                        @lang('lang.staff')  @lang('lang.id') 
                    </div>
                    <div class="value">

                        {{sprintf("%03d", @$staffDetails->staff_no)}} 
        ...
        <div class="single-meta">
            <div class="d-flex justify-content-between">
                <div class="name">
                   @lang('lang.contarct') @lang('lang.type')
                </div>
                <div class="value">
...
<div class="single-info">
    <div class="row">
        <div class="col-lg-5 col-md-5">
            <div class="">
               @lang('lang.current') @lang('lang.address') 
            </div>
        </div>
...
<div class="single-info">
    <div class="row">
        <div class="col-lg-5 col-md-5">
            <div class="">
                 @lang('lang.account')  @lang('lang.number')
            </div>
        </div>
    ...
    <div class="white-box">
        ...
        <thead>
            <tr>
                ...
                <th width="15%">@lang('lang.net_salary')({{$currency_symbol}})</th>
            ...
            <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <td>
                        ...
                        <button class="primary-btn small bg-success text-white border-0"> @lang('lang.spproved')</button>
                        @endif
                    ...
                    <td>
                        <a class="modalLink" data-modal-size="modal-md" title="View Leave Details" href="{{url('view-leave-details-apply', @$value->id)}}"><button class="primary-btn small tr-bg"> View </button></a>
                    </td>
                </tr>
                @endforeach
                @else 
    ...
    <div class="white-box">
        ...
        cellspacing="0">
            ...
            <tbody class="d-block">
                ...
                <tr class="d-flex">
                    <td class="col-8"> @lang('lang.other')  @lang('lang.documents')</td>
                    <td class="col-4">
