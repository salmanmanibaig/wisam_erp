...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.add') @lang('lang.notice')</h1>
            <div class="bc-pages">
                <a href="{{url('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('lang.communicate')</a>
                <a href="#">@lang('lang.add') @lang('lang.notice')</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="main-title">
                    <h3 class="mb-30">@lang('lang.create') @lang('lang.notice')</h3>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            ...
                            <div class="input-effect">
                                <textarea class="primary-input form-control" cols="0" rows="7" name="notice_message" id="notice_message"></textarea>
                        ...
                        <div class="col-lg-12 mt-50">
                            <label>@lang('lang.notice') @lang('lang.Permission_For')</label><br>
