        ...
        <div class="row justify-content-between">
            <div class="col-lg-4 col-sm-6">
                ...
                <div class="main-title">
                    <h3 class="mb-30 md-xs-2">@lang('lang.all') @lang('lang.notices')</h3>
                </div>
                @endif

            </div>
            <div class="col-lg-3 text-sm-right col-sm-6">
                <a href="{{url('create-notice')}}" class="primary-btn small fix-gr-bg">
                ...
                <div id="accordion">
                   ...
                   <div class="card ">
                     <a class="card-link " data-toggle="collapse" href="#notice{{@$value->id}}">
                        <div class="card-header notice_single d-flex justify-content-between">
