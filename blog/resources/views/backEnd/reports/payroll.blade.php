    ...
    <div class="col-lg-12">
        <div class="row">
            <div class="col-lg-1 no-gutters">
                <div class="main-title">
                    <h3 class="mt-10">@lang('lang.staff_list')</h3>
                </div>
            </div>
            <div class="col-lg-2 no-gutters">
                <a href="{{url('print-payroll-report', [@$role_id, @$payroll_month, $payroll_year])}}" id="fees-groups-print-button" class="primary-btn medium fix-gr-bg" target="_blank">
            ...
            <div class="col-lg-12">
                <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th>@lang('lang.basic_salary')({{@$currency_symbol}})</th>
                            <th>@lang('lang.earnings')({{@$currency_symbol}})</th>
                            <th>@lang('lang.deductions')({{@$currency_symbol}})</th>
                            <th>@lang('lang.gross_salary')({{@$currency_symbol}})</th>
                            <th>@lang('lang.tax')({{@$currency_symbol}})</th>
                            <th>@lang('lang.net_salary')({{@$currency_symbol}})</th>
                        </tr>
                    </thead>
                ...
                <tfoot>
                    <tr>
                        ...
                        <th>{{@$currency_symbol}}{{App\User::NumberToBangladeshiTakaFormat(@$basic_salary)}}</th>
                        <th>{{@$currency_symbol}}{{App\User::NumberToBangladeshiTakaFormat(@$earnings)}}</th>
                        <th>{{@$currency_symbol}}{{App\User::NumberToBangladeshiTakaFormat(@$deductions)}}</th>
                        <th>{{@$currency_symbol}}{{App\User::NumberToBangladeshiTakaFormat(@$gross_salary)}}</th>
                        <th>{{@$currency_symbol}}{{App\User::NumberToBangladeshiTakaFormat(@$tax)}}</th>
                        <th>{{@$currency_symbol}}{{App\User::NumberToBangladeshiTakaFormat(@$net_salary)}}</th>
                    </tr>
                </tfoot>
            </table>
        </div>
