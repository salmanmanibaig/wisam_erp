        ...
        <div class="row">
         <div class="col-lg-3">
            ...
            <div class="student-meta-box">
                ...
                @if (file_exists(@$staffDetails->staff_photo))
...
<div class="col-lg-9 staff-details">
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li class="nav-item edit-button">
            <a href="{{url('customer-edit/'.@$staffDetails->id)}}" class="primary-btn small fix-gr-bg">@lang('lang.edit')
            </a>
        </li>
    </ul>
...
<h4 class="stu-sub-head mt-40">@lang('lang.bank_account') @lang('lang.details')</h4>
...
<div class="single-info">
    <div class="row">
        <div class="col-lg-5 col-md-5">
            <div class="">
               @lang('lang.branch')  @lang('lang.name')
           </div>
       </div>
