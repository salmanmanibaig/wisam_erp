...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.enlisted_suppliers') </h1>
            <div class="bc-pages">
                <a href="{{url('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('lang.enlisted_suppliers')</a>
                <a href="#">@lang('lang.enlisted_suppliers') </a>
            </div>
        </div>
    </div>
...
<section class="admin-visitor-area">
    <div class="container-fluid p-0">
        @if(isset($editData))
            @if(in_array(270, @$module_links) ||  Auth::user()->role_id == 1)
            <div class="row">
                        ...
                        <div class="main-title">
                            <h3 class="mb-30">
                                ...
                                @else
                                    @lang('lang.add')
                                @endif
                                @lang('lang.enlisted_suppliers')
                            </h3>
                        </div>
                        @if(isset($editData))
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'enlisted-suppliers/'.@$editData->id, 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
                        @else
                        @if(in_array(270, @$module_links) ||  Auth::user()->role_id == 1)
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'enlisted-suppliers','method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                        @endif
                        @endif
                        <div class="white-box">
            ...
            <div class="col-lg-9">
              ...
              <div class="row">
                <div class="col-lg-4 no-gutters">
                    <div class="main-title">
                        <h3 class="mb-0"> @lang('lang.enlisted_suppliers') </h3>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <table id="table_id" class="display school-table pl-2" cellspacing="0" width="100%">
                        <thead>
                            ...
                            <tr>
                                <th> @lang('lang.sl') </th>
                                <th> @lang('lang.contact_person_name') </th>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            @if(in_array(271, @$module_links) ||  Auth::user()->role_id == 1)
                                            <a class="dropdown-item" href="{{url('enlisted-suppliers/'.@$value->id.'/edit')}}"> @lang('lang.edit')</a>
                                            @endif
                                            @if(in_array(272, @$module_links) ||  Auth::user()->role_id == 1)
                                            <a class="deleteUrl dropdown-item" data-modal-size="modal-md" title="Delete Enlisted Supplier" href="{{url('delete-enlisted-suppliers-view/'.@$value->id)}}"> @lang('lang.delete')</a>
                                            @endif
