                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                ...
                                <div class="row mt-25 {{!isset($editData)? 'disabledbutton':''}}">
                                    <div class="col-lg-12"> 
                                        <div class="input-effect">
                                            <input type="checkbox" id="weekend" class="common-checkbox" name="is_weekend" value="1" {{isset($editData)?(@$editData->is_weekend == 1? 'checked':''):''}}>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    @if(in_array(212, @$module_links) || Auth::user()->role_id == 1)
