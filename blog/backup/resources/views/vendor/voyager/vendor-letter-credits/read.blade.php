                    ...
                    <!-- form start -->
                        ...
                        <!-- Adding / Editing -->
                            ...
                            <table class="table table-striped" id="myTable">
                                ...
                                @foreach($letter_credit->blnumber as $key=>  $credit)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group" >
                                                ...
                                                <input class="form-control" value="{{$credit->bl_number}}" required type="text" name="bl_number[]">
                                            </div>

                                        </td>

                                        <td>
                                            <input class="form-control bl_qty"   value="{{$credit->bl_qty}}"  type="number" name="qty[]" >
                                        </td>
                                        <td>
                                            <input class="form-control"  value="{{$credit->gd_number}}"  type="text" name="gd_number[]" >
                                        </td>
        ...
        $(document).ready(function () {
            ...
            $("#btn1").click(function () {
                ...
                $("#acc_table").append("      <tr>\n" +
                    ...
                    "                                            </td>\n" +
                    "                                            <td>\n" +
                    "                                                <input class=\"form-control\" required  type=\"text\" name=\"gd_number[]\" >\n" +
                    "                                            </td>\n" +
                    "\n" +
                    "                                            <td>\n" +
                    "                                                <button type=\"button\"   class=\"btn btn-danger  btnDelete\"><i class=\"voyager-trash\"></i> </button>\n" +
