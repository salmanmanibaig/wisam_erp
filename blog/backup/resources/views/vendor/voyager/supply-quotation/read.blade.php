...
@section('page_header')
    ...
    <h1 class="page-title">
        <i class=""></i> {{ __('voyager::generic.viewing') }}
            ...
            <a href="{{url('admin/edit-quotation/'.$quotations->id)}}" class="btn btn-info customBtn">
                        ...
                        <!-- Adding / Editing -->
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <h4>{{sprintf("%04d",$quotationNo).date('-y-m',strtotime($quotations->date))}}</h4>
                                    <br>
{{--                                    <label for="" class="font-weight-bold">00</label>--}}
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                        ...
                                        <input type="date" name="date" value="{{date('yy-m-d', strtotime($quotations->date))}}" readonly class="form-control">
                                </div>
                                <div class="col-md-4">
                                    <label for="factory" class="font-weight-bold">Usage : <span class="color">*</span></label>
                                    <input type="text" name="factory" value="{{$quotations->factory}}" readonly class="form-control">
                                </div>
                                <div class="col-md-4">
                                    <label for="Remarks" class="font-weight-bold">Remarks : <span class="color">*</span></label>
                                    <input type="text" name="Remarks" value="{{$quotations->remarks}}" readonly class="form-control">
                                </div>
                            </div>
                            <div class="row">
                                <div class="table table-responsive">
                                    <table class="table table-striped " id="myTable">
                                        ...
                                        <tbody id="accTable">
                                        @foreach($quotations->quotationDetails as $detail)
                                        <tr>
                                            <td>
...
{{--                                    </div>--}}
                    ...
                    <div class="input-group" style="float: right">
                        ...
                        <input type="number"  value="{{$quotations->totalPrice}}" readonly id="" class="form-control col-md-2" style="width: 150px; margin-right: 5px;">
                    </div>
                    <a href="{{url('admin/approve-quotation')}}/{{$quotations->id}}">
