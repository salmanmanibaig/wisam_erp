...
@php  $role_check=App\Hospital::first(); @endphp
...
{{--                <a href="{{url('admin/hospitals/create')}}" type="button" class="btn btn-success ">--}}
...
{{--                                        {{dd($hospitals)}}--}}
                                        ...
                                        <tr id="myTable">
                                            ...
                                            <td>
                                                <span class="font-weight-bold">{{$hospital->id}}</span>
                                            </td>

{{--                                            {{dd($hospital->user)}}--}}
                                            <td>
                                                <span class="font-weight-bold">{{$hospital->name }}</span>
                                            </td>
                                            <td>

                                                <span class="font-weight-bold">{{@$hospital->address}}</span>
                                            </td>

                                            <td>
                                                <span class="font-weight-bold">{{$hospital->phone}}</span>
                                            </td>

                                            <td>
                                                <span class="font-weight-bold">{{$hospital->mobile}}</span>
                                            </td>

{{--                                            <td>--}}
{{--                                                <span class="font-weight-bold">{{$hospital->department}}</span>--}}
{{--                                            </td>--}}
{{--                                            --}}{{--                                            {{dd($course)}}--}}
{{--                                            <td>--}}
{{--                                                @if($course->publish)--}}
{{--                                                    <div class="font-weight-bold status text-uppercase  ">{{$hospitals->publish}}</div><br>--}}
{{--                                                @endif--}}
{{--                                                @if($course->trending)--}}
{{--                                                    <div class="font-weight-bold status text-uppercase" style="background: #4dbd74 !important">{{$hospitals->trending}}</div><br>--}}
{{--                                                @endif--}}
{{--                                                @if($course->feature)--}}
{{--                                                    <span class="font-weight-bold status" style="background: yellowgreen"><span class="text-uppercase">{{$hospitals->feature}}</span></span><br>--}}
{{--                                                @endif--}}
{{--                                                @if($course->popular)--}}
{{--                                                    <span class="font-weight-bold status text-uppercase" style="background: #20a8d8 !important">{{$hospitals->popular}}</span><br>--}}
{{--                                                @endif--}}
{{--                                                @if($course->free)--}}
{{--                                                    <span class="font-weight-bold status text-uppercase" style="background: #f39c12">{{$hospitals->free}}</span>--}}
{{--                                                @endif--}}
{{--                                            </td>--}}
