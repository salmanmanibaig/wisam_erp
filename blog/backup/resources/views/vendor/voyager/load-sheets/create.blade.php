                    ...
                    <div class="panel-body">
                        <form action="{{url('admin/load-sheets')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="panel-footer">
                                <button id="submit" type="submit"  class="btn btn-primary save">{{ ('Create Load Sheet') }}</button>
                            </div>
                                    ...
                                    @foreach($booking as $key => $book)
                                        ...
                                        <tr id="myTable">
                                            ...
                                            <td>
                                                ...
                                                <input type="hidden"class="font-weight-bold" name="book_id[]" value= "{{$book->id}}" >
                                            </td>
                                            ...
                                            <td class="no-sort no-click text-right" id="bread-actions">
                                                <div class="btn-toolbar">
                                                    <a href='{{url("admin/courses/{$book->id}/edit")}}' class="btn btn-danger pull-right des" style="text-decoration: none; font-size: 12px;padding: 5px 7px">
                                                        <i class="voyager-eye"></i> <span>Cancel</span>
                                                    </a>

                                                    <a href='{{url("admin/courses/{$book->id}")}}' class="btn btn-warning pull-right des" style="text-decoration: none; font-size: 12px;padding: 5px 7px">
